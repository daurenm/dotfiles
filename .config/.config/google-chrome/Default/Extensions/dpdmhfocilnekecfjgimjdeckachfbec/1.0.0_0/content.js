...
Promise.all([
  ...
  var add_custom_attachment_card, add_downlaod_to_dropbox_button, compose_view_handler, create_onboarding_flyout, create_photo_preview_elem, display_chooser, get_link_previews, is_eligible_link, log, log_guid, log_key, message_view_handler, parse_file_name, register_all_handlers, removeTooltip, sdk, set_onboarding_tooltip_seen, show_onboarding_tooltip, skip_onboarding, trigger_onboarding;
  sdk = results[0];
  ...
  message_view_handler = function(message_view) {
    ...
    add_downlaod_to_dropbox_button(message_view);
  };
  trigger_onboarding = function() {
    sdk.Compose.openNewComposeView();
  };
  register_all_handlers();
  add_downlaod_to_dropbox_button = function(message_view) {
  ...
  create_photo_preview_elem = function(file, thumbnail_link) {
    ...
    img.style = 'max-width:425px; max-height:800px';
